...
NOTE : While generating your release build and the corresponding partnerKey, please refer to this section for [generating partner key for release build](#c-generating-partner-key-for-release-build).
